...
//         // If there are no reviews available, just skip without showing an error
...
//           setDisplayedReviews(sortedReviews.slice(0, 2)); // Display only the first 2 reviews initially
...
//               <button
//                 type="submit"
//                 className="w-full bg-indigo-600 text-white py-3 px-6 rounded-lg hover:bg-indigo-700 transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
//               >
//                 Submit Your Review
//               </button>
//             </form>
