...
const GetAllBuyers = () => {
  ...
  useEffect(() => {
    axios.get(`${config.apiUrl}/B2B/buyer&seller/fetchAllBuyers`)
      .then(response => {
  ...
  return (
    ...
    <div className="container  mx-auto p-4">
      <h2 className="text-3xl font-bold mb-4 text-center bg-gradient-to-r from-lime-400 to-red-400 text-white py-2 rounded-md">All Buyers</h2>
