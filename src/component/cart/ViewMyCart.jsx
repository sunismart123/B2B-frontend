...
const ViewMyCart = () => {
  ...
  const { carts, cartAmount, loading, fetchCart, updateCart, deleteCart } =
    useCart();
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-sm text-gray-500">
                        Seller:{' '}
                        {cart.product.seller?.firstName || 'Not Available'}
                      </p>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                ...
                <button
                  onClick={checkout}
                  className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-full transition duration-300 mb-4"
                >
                  Proceed to Checkout
                </button>
                <button
